...
std::vector<std::shared_ptr<Node>>getNeighbourNodes(std::shared_ptr<Node> currentNode, std::vector<std::shared_ptr<Node>>neighbourNodes)
{
...
{ // main function in Pathfinder.cpp contains a majority of the A* algorithm 
	...
	std::shared_ptr<Node> startNode(&start);
	std::shared_ptr<Node> goalNode(&goal);
